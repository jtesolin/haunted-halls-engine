...
model_requests = Table(
    ...
    Integer("estimated_input_tokens", nullable=False), Integer("actual_input_tokens", nullable=False),
    Integer("actual_output_tokens", nullable=False), Integer("latency_ms", nullable=False),
